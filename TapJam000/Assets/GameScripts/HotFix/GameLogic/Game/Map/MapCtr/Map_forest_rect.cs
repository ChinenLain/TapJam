...
namespace GameLogic
{
    public class Map_forest_rect : MapCtrBase
    {
        ...
        public override async UniTask AddRes()
        {
            ...
            background.Add(await GameModule.Resource.LoadAssetAsync<Sprite>("backtree-01"));
            background.Add(await GameModule.Resource.LoadAssetAsync<Sprite>("backtree-02"));
            background.Add(await GameModule.Resource.LoadAssetAsync<Sprite>("backtree-03"));
